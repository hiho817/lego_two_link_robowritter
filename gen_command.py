...
def main():
    ...
    points = [
        np.array([[0.110], [0.170], [0.0]]),
        np.array([[0.140], [0.170], [0.0]]),

        np.array([[0.100], [0.155], [0.0]]),
        np.array([[0.150], [0.155], [0.0]]),

        np.array([[0.09], [0.140], [0.0]]),
        np.array([[0.16], [0.140], [0.0]]),
        ...
        np.array([[0.15], [0.12], [0.0]]), # let Y recalibrate 

        np.array([[0.12], [0.138], [0.0]]),
        np.array([[0.12], [0.09], [0.0]]),

        np.array([[0.12], [0.12], [0.0]]),
        np.array([[0.15], [0.12], [0.0]]),
        np.array([[0.15], [0.09], [0.0]]),
        
        np.array([[0.11], [0.11], [0.0]]),
        np.array([[0.15], [0.11], [0.0]]),
