...
def main():
    ...
    points = [
        np.array([[0.118], [0.168], [0.0]]),
        np.array([[0.141], [0.173], [0.0]]),

        np.array([[0.116], [0.154], [0.0]]),
        np.array([[0.139], [0.16], [0.0]]),

        np.array([[0.101], [0.136], [0.0]]),
        np.array([[0.154], [0.144], [0.0]]),
